      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-right" data-aos-delay="100">
            <a href="restaurant.html"><img src="<?php bloginfo('template_url'); ?>/img/img_2.jpg" alt="Image placeholder" class="img-fluid"> </a>
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-right" data-aos-delay="200">
            <a href="hotel.html"><img src="<?php bloginfo('template_url'); ?>/img/img_4.jpg" alt="Image placeholder" class="img-fluid"> </a>
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-right" data-aos-delay="300">
            <a href="yacht.html"><img src="<?php bloginfo('template_url'); ?>/img/img_5.jpg" alt="Image placeholder" class="img-fluid"> </a>
