        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media media-custom d-block mb-4">
              <a href="#" class="mb-4 d-block"><img src="<?php bloginfo( 'template_url' ); ?>/img/person_3.jpg" alt="Image placeholder" class="img-fluid"></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4">
              <a href="#" class="mb-4 d-block"><img src="<?php bloginfo( 'template_url' ); ?>/img/person_1.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4">
              <a href="#" class="mb-4 d-block"><img src="<?php bloginfo( 'template_url' ); ?>/img/person_2.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
